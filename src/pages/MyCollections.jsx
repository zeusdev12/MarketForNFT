    ...
    <div className='min-h-screen overflow-hidden bg-[#0c0c0c] background'>
      ...
      <div className="relative z-30 mt-[110px] lg:mt-[188px] pl-5 lg:pl-0 lg:px-0 lg:mr-5 lg:ml-[40px] 3xl:ml-[120px] lg:max-w-[1170px]">
        ...
        <div className='flex flex-col lg:flex-row mt-3.5 lg:mt-2 mr-5 lg:mr-0'>
          <a href="/collections/add" className="relative flex flex-row items-center justify-center w-full lg:w-[116px] h-[58px] rounded-[41px] bg-[#beff55] text-black font-gilroy font-semibold text-base mt-2 tracking-wide before:absolute before:top-0 before:-left-[100px] before:w-[40px] before:h-full before:bg-white before:blur-[30px] before:skew-x-[30deg] hover:before:left-[300px] sm:hover:before:left-52 hover:before:duration-1000 overflow-hidden">Add </a>
          <a href="/collections/create" className="relative flex flex-row lg:ml-2 items-center justify-center w-full lg:w-[116px] h-[58px] rounded-[41px] bg-[#beff55] text-black font-gilroy font-semibold text-base mt-2 tracking-wide before:absolute before:top-0 before:-left-[100px] before:w-[40px] before:h-full before:bg-white before:blur-[30px] before:skew-x-[30deg] hover:before:left-[300px] sm:hover:before:left-52 hover:before:duration-1000 overflow-hidden">Create </a>
        </div>
