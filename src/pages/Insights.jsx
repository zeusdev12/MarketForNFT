...
const Insights = () => {
  return (
    <section>
      {/* <div className='bg-[#0c0c0c] w-full min-h-screen pt-40'>
            <div className="mx-auto max-w-[1200px] py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
              ...
              <div className="mt-12 pt-8">
                <p className="text-sm text-[#F9FAFA80] font-gilroy font-medium tracking-wider xl:text-center">©2022 Crypto Market, Inc. All Rights Reserved.</p>
              </div>
            </div>
        </div> */}
